...
/** sample Handler comments
* @param {event object} event
*
* processess poiterdown and pointerup event for each button
*/
function PointerHandlerABC(event){
  event.preventDefault();
  /* handle pointerdown and double tap: update keyboard display*/
  if (event.type === "pointerdown"){
    ...
    if(!tapped){
      ...
      clearTimeout(tapped);
      tapped=null;
      // enter corresponding autocomplete words
  ...
  /* handle pointerup: output text to text_area and reset keyboard display*/
...
/**
* @param {event Object, string,string,string,string} event,ch1,ch2,ch3,ch4
*
...
/**
* @param {string,string,string} stu_ch, abc_ch, ghi_ch
*
* assign text to corresponding button
*/
...
/***
* reset all buttons with default text
*/
function restoreall(){
    let all_buttons = document.getElementsByClassName("keyboard_key");
    Array.prototype.forEach.call(all_buttons, function(single_button) {
...
* @return {int} quadrant
*
* return released cursor position in relative quadrant
*/
